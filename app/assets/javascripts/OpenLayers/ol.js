    ...
    */
    ...
    function zc(a) {
        ...
        if (a instanceof sc) b = a;
            ...
            var b = tc[a] || null,
                c = rc || window.proj4;
            b || "function" != typeof c || void 0 === c.defs(a) || (b = new sc({
                code: a
            }), Ic(b))
        }
        return b
        ...
        for (m = c.length; l < m; ++l) {
            ...
            a: {
                ...
                if (b != q) {
                    ...
                    var A, O;
                    do
                        if (A = u * Math.round(n[b] / u), O = u * Math.round(n[b + 1] / u), b += r, b == q) {
                            w[g++] = A;
                            w[g++] = O;
                            break a
                        }
                                                ...
                                                if (Ma in n.a) {
                                                    ...
                                                    for (Ja = n.a[Ma].length; O < Ja; ++O) {
                                                        ...
                                                        if (ca.ea < La.ea || ca.ca > La.ca)
                                                            if (Wd(D, new Td(oa(ca.ea, kb), oa(ca.ca, kb), ca.ga, ca.ja)) || ca.ca - ca.ea + 1 > kb && Wd(D, La)) {
                                                                n = !0;
                                                                break a
                                                            }
                                                    }
    ...
    function Bg(a) {
        a = a ? a : {};
        lg.call(this, {
            handleEvent: a.handleEvent ? a.handleEvent : Cg
        });
    ...
    function ph(a) {
        ...
        (void 0 !== a.dragPan ? a.dragPan : 1) && b.push(new Eg({
            kinetic: c
        }));
        (void 0 !== a.pinchRotate ? a.pinchRotate : 1) && b.push(new gh);
        (void 0 !== a.pinchZoom ? a.pinchZoom : 1) && b.push(new kh({
            duration: a.zoomDuration
        }));
    ...
    function Mi(a, b) {
        var c = a.f,
            d = a.U;
        d ? d.fillStyle != b.fillStyle && (d.fillStyle = c.fillStyle = b.fillStyle) : (c.fillStyle = b.fillStyle, a.U = {
    ...
    k.$d = function(a, b, c, d, e) {
        ...
        for (f = this.u.length - 1; 0 <= f; --f)
            for (g = this.l[f], a.uniform4fv(this.H.D, g[0]), rk(this, a, g[1], g[2]), l = this.u[f]; 0 <= n && this.g[n] >= l;) {
                g = this.g[n];
                m = this.i[n];
                p = x(m).toString();
    ...
    k.$d = function(a, b, c, d, e) {
        ...
        for (f = this.u.length - 1; 0 <= f; --f)
            for (a.bindTexture(3553, this.u[f]), g = 0 < f ? this.H[f - 1] : 0, l = this.H[f]; 0 <= n && this.g[n] >= g;) {
                h = this.g[n];
                m = this.i[n];
                p = x(m).toString();
    ...
    k.$d = function(a, b, c, d, e) {
        ...
        for (f = this.l.length - 1; 0 <= f; --f)
            for (g = this.u[f], Sk(this, a, g[0], g[1], g[2]), l = this.l[f]; 0 <= n && this.g[n] >= l;) {
                g = this.g[n];
                m = this.i[n];
                p = x(m).toString();
                if (void 0 === c[p] && m.V() && (void 0 === e || jc(e, m.V().G())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), lk(a, b, g, h), h = d(m))) return h;
    ...
    function Bl(a, b, c, d, e) {
        ...
        for (f = m.length; d < f; ++d)
            for (g in m[d]) h = m[d][g], "object" !== typeof h || e && !h.qb || h.x === a.x && h.y === a.y || h.x === b.x && h.y === b.y || h.x === c.x && h.y === c.y || -1 !== l.indexOf(h) || !qd([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, h.x, h.y) || l.push(h);
        return l
    }
    ...
    k.$d = function(a, b, c, d, e) {
        ...
        for (f = this.c.length - 1; 0 <= f; --f)
            for (g = this.u[f], a.uniform4fv(this.H.D, g), l = this.c[f]; 0 <= n && this.g[n] >= l;) {
                g = this.g[n];
                m = this.i[n];
                p = x(m).toString();
                if (void 0 === c[p] && m.V() && (void 0 === e || jc(e, m.V().G())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), lk(a, b, g, h), h = d(m))) return h;
    ...
    k.Ma = function(a, b) {
        ...
        b ? this.j.Ma(null, b) : this.j.Ma(null, new wi({
            color: [0, 0, 0, 0],
            lineWidth: 0
        }))
    };
    ...
    function im(a) {
        if ("string" === typeof a) return [new pe({
            html: a
        })];
    ...
    function Km(a) {
        ...
        e = a.layers instanceof yh ? a.layers : new yh({
            layers: a.layers
        });
        c[Lm] = e;
        c[Om] = a.target;
    ...
    function Mn(a, b, c) {
        if (a.nodeType == Node.CDATA_SECTION_NODE || a.nodeType == Node.TEXT_NODE) b ? c.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(a.nodeValue);
            ...
            for (a = a.firstChild; a; a = a.nextSibling) Mn(a, b, c);
        return c
    }
    ...
    k.mj = {
        "http://www.opengis.net/gml": {
            patches: Sn(tp.prototype.Lo)
        }
    };
    k.Yi = {
        "http://www.opengis.net/gml": {
            segments: Sn(tp.prototype.Oo)
        }
    };
    k.Zi = {
        "http://www.opengis.net/gml": {
    ...
    k.fj = {
        "http://www.opengis.net/gml": {
            PolygonPatch: Sn(tp.prototype.Mo)
        }
    };
    k.kj = {
        "http://www.opengis.net/gml": {
            LineStringSegment: Sn(tp.prototype.Go)
        }
    };
    ...
    k.zp = function(a, b, c) {
        ...
        $n({
            node: a
        }, vp, Xn, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
    };
    k.Qi = function(a, b, c) {
        var d = c[c.length - 1].srsName;
        d && a.setAttribute("srsName", d);
    ...
    k.Ap = function(a, b, c) {
        ...
        $n({
            node: a,
            srsName: d
        }, yp, Vn("pointMember"), b, c, void 0, this)
    };
    k.Ri = function(a, b, c) {
        var d = c[c.length - 1],
            e = d.srsName,
    ...
    k.Qd = {
        "http://www.opengis.net/gml": {
            coordinates: Sn(Cp.prototype.bi)
        }
    };
    k.We = {
        "http://www.opengis.net/gml": {
    ...
    k.Wi = {
        "http://www.opengis.net/gml": {
            coordinates: Rn(Cp.prototype.bi)
        }
    };
    k.lg = {
        "http://www.opengis.net/gml": {
    ...
    function Wp(a, b, c) {
        ...
        $n({
            node: a
        }, Xp, Xn, [b.linkText, b.linkType], c, Yp)
    }
    ...
    function Dq(a) {
        ...
        this.b = void 0 !== a.fill ? a.fill : new vi({
            color: "#333"
        });
    ...
    function Eq(a) {
        a = a ? a : {};
        dp.call(this);
        Fq || (Gq = [255, 255, 255, 1], Hq = new vi({
            color: Gq
        }), Iq = [20, 2], Jq = Kq = "pixels", Lq = [64, 64], Mq = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", Nq = .5, Oq = new xq({
            anchor: Iq,
            anchorOrigin: Cq,
            anchorXUnits: Kq,
            anchorYUnits: Jq,
    ...
    function lr(a, b) {
        ...
        if (e)
            if ("Point" == f) {
                ...
                d.da(e, f);
                nr(d, c)
            } else "LineString" == f ? (d = new Q(null), mo(d, c), nr(d, c)) : "Polygon" == f ? (d = new S(null), oo(d, c), nr(d, c)) : "GeometryCollection" == f ? d = new Vo(c) : ha(!1, 37);
        else d = new Vo(c);
        return d
    }
    ...
    var xr = M(Vq, {
        ...
        sr = M(Vq, {
            ...
            LabelStyle: function(a, b) {
                var c = N({}, Fr, a, b);
                c && (b[b.length - 1].textStyle = new Dq({
                    fill: new vi({
    ...
    var os = M(Vq, ["Document", "Placemark"]),
        ...
        ds = M(Vq, {
            ExtendedData: L(function(a, b, c) {
                ...
                var d = b.names;
                b = b.values;
                for (var e = d.length, f = 0; f < e; f++) $n(a, ss, Ds, [{
                    name: d[f],
                    value: b[f]
                }], c)
            }),
            ...
            return function d(a, b, g) {
                ...
                4: [function(a, b) {
                    ...
                    f.prototype.fh = function() {
                        var a = this.rc;
                        a.ha = this.Ye;
                        for (var b = a.Ia() + a.ha, d = 1, e = 0, f = 0, g = 0, u = [], w; a.ha < b;)
    ...
    var st = {
        ...
        MultiPoint: function(a, b, c) {
            ...
            var d, e;
            if (b && c)
                for (d = 0, e = a.length; d < e; ++d) tt(a[d], b, c);
            return new R(a)
        },
    ...
    var zt = {
        "http://www.opengis.net/gml": {
            boundedBy: K(gp.prototype.Ee, "bounds")
        }
    };
    ...
    var Ht = {
        "http://www.opengis.net/wfs": {
            Query: L(function(a, b, c) {
                ...
                if (d = d.filter) g = Kn("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), $n({
                    node: g
                }, Ht, Vn(d.Nb), [d], c)
            })
        },
        ...
        if (this.P && "pointerdrag" != this.P.type) {
            ...
            for (n in c) {
                ...
                d && (d = b, this.o = !0, d.qa(f), this.o = !1, f = [], void 0 !== h && (this.i.remove(h), f.push(h.ta[0])), void 0 !== m && (this.i.remove(m), f.push(m.ta[1])), void 0 !== h && void 0 !== m && (h = {
                    ...
                    index: l,
                    ta: f
                }, this.i.Da(Gb(h.ta), h)), Cw(this, b, g, p.depth, -1), this.a && (this.D.la().rb(this.a), this.a = null))
            }
    ...
    function Vi(a, b, c, d, e) {
        ...
        for (var f = !0, g, h, l = d.ea; l <= d.ca; ++l)
            for (var m = d.ga; m <= d.ja; ++m) g = a.Lb(c, l, m), h = !1, b.b.hasOwnProperty(g) && (g = b.get(g), (h = g.W() === cg) && (h = !1 !== e(g))), h || (f = !1);
        return f
    }
    k.qf = function() {
        return 0
    ...
    function sx(a) {
        ...
        var b = void 0 !== a.projection ? a.projection : "EPSG:3857",
            c = void 0 !== a.tileGrid ? a.tileGrid : oe({
                extent: me(b),
                maxZoom: a.maxZoom,
                minZoom: a.minZoom,
                tileSize: a.tileSize
                    ...
                    l.prototype.xj =
                        function() {
                            var a = this.$e,
                                b = this.Wd.length,
                                d, e;
                            if (1 === b) d = new Uint8ClampedArray(this.Sc[0].buffer), e = this.Sc[0].meta;
                            else {
    ...
    function Kx(a) {
        for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
            var e = d,
                f = a[d],
                g = null;
            f instanceof ix ? (f = new F({
                source: f
            }), g = new ij(f)) : f instanceof km && (f = new ei({
                source: f
            }), g = new hj(f));
            c[e] = g
        }
